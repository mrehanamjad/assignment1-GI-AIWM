...
const Animals:string[] = ['Lion','tiger','cheetah']

Animals.forEach(Animal=>{
    console.log(`${Animal} is large carnivorous felines(cat family).`);
})
console.log("~ These animals are all large carnivorous felines ~");